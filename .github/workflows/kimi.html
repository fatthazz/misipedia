...
<head>
    ...
    <style>
        ...
        .profile h2 {
            font-size: 2em;
            color: #444;
            margin-bottom: 10px; /* Space below the character name */
        }
        .detail-item {
...
<section class="profile" id="misi-characters">
    <h2>Kimi</h2>
    <img src="image/kimi.png" alt="Kimi"> <!-- Replace with the character image URL -->

    <div class="detail-item">
        <strong>Nama Penuh:</strong>
        <span class="detail-text">Akimi bin Sunarjo</span>
    </div>
	 <div class="detail-item">
        <strong>Misi:</strong>
        <span class="detail-text">Detektif</span>
    </div>
    <div class="detail-item">
        <strong>Kemahiran:</strong>
        <span class="detail-text">Kimia,Penyiasatan</span>
    </div>
    <div class="detail-item">
        <strong>Perilaku:</strong>
        <span class="detail-text">Seorang yang santai, sering melakukan eksperimen terlarang. Sherlock Holmes misi.</span>
    </div>
    <div class="detail-item">
        <strong>Penampilan:</strong>
        <span class="detail-text">Berkulit sawo matang. Mudah senyum.Tak mudah melatah</span>
    </div>
    <div class="detail-item">
        <strong>Sekilas:</strong>
        <span class="detail-text">Kimi..</span>
    </div>
</section>
